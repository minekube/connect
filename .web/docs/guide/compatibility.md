...
| LibreLogin with premium autologin enabled | High | Known incompatible. The player's login never completes. See [Login and Auth Plugins](/guide/login-plugins#known-incompatible-librelogin-with-premium-autologin) for the workaround and its limitations. |
